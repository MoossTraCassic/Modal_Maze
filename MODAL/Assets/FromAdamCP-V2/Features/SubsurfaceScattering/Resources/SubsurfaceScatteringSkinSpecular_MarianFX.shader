...
Shader "ADAM2/SubsurfaceScattering/Skin (Specular, MarianFX)"
{
    Properties
    {
		...
		_Transition("Transition Value", Range(0.0, 1.0)) = 1.0
		_TransWidth("Transition Width", Float) = 0.05
        _TransMap("Transition Map", 2D) = "black" {}
    ...
    CGINCLUDE
		...
		#define SUBURFACE_INPUTS_MARIAN_FX
    ENDCG
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "UnityStandardCoreForward_MarianFX.cginc"
    ...
    FallBack Off
    CustomEditor "SubsurfaceScatteringSkin_MarianFXGUI"
}
